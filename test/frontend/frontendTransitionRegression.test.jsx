...
import AppShell from '../../frontend/src/app/shell/AppShell';
...
import OperationsCenterPage from '../../frontend/src/app/contexts/operations/OperationsCenterPage';
import ActiveTradesPanel from '../../frontend/src/app/contexts/profile/ActiveTradesPanel';
import { getStateLabel } from '../../frontend/src/app/copy';
import { buildGoToTradeRoomAction } from '../../frontend/src/app/actions/tradeNavigationActions';
import { isSupportedChainId } from '../../frontend/src/app/chainPolicy';
import { buildTradeDecisionModel } from '../../frontend/src/app/contexts/trade-room/tradeDecisionModel';
import TradeRoomPage from '../../frontend/src/app/contexts/trade-room/TradeRoomPage';
import { getOrderSideCopy } from '../../frontend/src/app/orderUiModel';
import PaymentRiskBadge from '../../frontend/src/components/PaymentRiskBadge';
import { APP_THEME_STORAGE_KEY, getInitialThemeMode } from '../../frontend/src/app/bootstrapState';
import { ThemeProvider, useThemeMode } from '../../frontend/src/app/providers/ThemeProvider';
