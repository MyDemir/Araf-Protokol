jest.mock('../../backend/scripts/services/siwe', () => ({
  verifyJWT: jest.fn(),
...
const { revokeRefreshToken, blacklistJWT, verifyJWT } = require('../../backend/scripts/services/siwe');
const { requireSessionWalletMatch, requireAuth } = require('../../backend/scripts/middleware/auth');
