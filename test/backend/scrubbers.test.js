jest.mock("../../backend/scripts/middleware/rateLimiter", () => ({ clientLogLimiter: (_req, _res, next) => next() }));
const { scrubBody } = require('../../backend/scripts/middleware/errorHandler');
const logsRoute = require('../../backend/scripts/routes/logs');
