...
describe("rate limiter alias cleanup", () => {
  it("uses canonical roomRead/coordinator names in trades route", () => {
    const tradesSource = fs.readFileSync(path.join(__dirname, "../../backend/scripts/routes/trades.js"), "utf8");
  ...
  it("does not export deprecated tradesLimiter alias", () => {
    const limiterSource = fs.readFileSync(path.join(__dirname, "../../backend/scripts/middleware/rateLimiter.js"), "utf8");
