...
- Backend Jest:
  - `auth.profile.test.js`: empty rail fallback yok ve unsupported rail reject doğrulaması.
  - `trades.risk.test.js`: rolling bank-change sinyalinin risk sonucuna yansıması.
- Contracts Hardhat:
