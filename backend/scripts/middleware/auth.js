...
/**
 * AUDIT FIX F-01: JWT artık httpOnly cookie'den okunuyor.
 *
 * ÖNCEKİ: Sadece Authorization: Bearer <token> header'ından okunuyordu.
 *   Sorun: JWT React state'te saklanıyordu → XSS ile çalınabilirdi.
 ...
 * AUDIT FIX F-01: Önce cookie, sonra header fallback.
 */
function _getTokenPayload(req) {
  // AUDIT FIX F-01: Önce httpOnly cookie'den oku
 ...
 * AUDIT FIX F-01: Reads from httpOnly cookie first, then Authorization header.
