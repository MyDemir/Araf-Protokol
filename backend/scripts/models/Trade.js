    ...
    payout_snapshot: {
      maker: {
        ...
        reputation_context_at_lock: {
          ...
          burn_count: { type: Number, default: null, min: 0 },
          auto_release_count: { type: Number, default: null, min: 0 },
          mutual_cancel_count: { type: Number, default: null, min: 0 },
          disputed_but_resolved_count: { type: Number, default: null, min: 0 },
        },
      },
      taker: {
        rail: { type: String, default: null },
