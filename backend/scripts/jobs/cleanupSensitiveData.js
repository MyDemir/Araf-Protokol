    ...
    const result = await Trade.updateMany(
      ...
      },
      {
        $set: {
          ...
          "payout_snapshot.maker.reputation_context_at_lock.disputed_but_resolved_count": null,
          ...
          "payout_snapshot.taker.reputation_context_at_lock.disputed_but_resolved_count": null,
