...
describe('frontend transition regression invariants', () => {
  ...
  it('migration_app_providers_wrap_app_without_moving_authority_logic_out_of_app', () => {
    ...
    expect(appSource).toContain('const handleReportPayment = async () =>');
    expect(appSource).toContain('const handleRelease = async () =>');
    expect(appSource).toContain('const handleChallenge = async () =>');
