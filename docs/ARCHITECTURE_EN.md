...
| Tier | TRY Limit | Maker Collateral | Taker Collateral | Cooldown | **Required Reputation for Access (On-Chain Enforced)** |
|---|---|---|---|---|---|
| **Tier 0** | 250 – 5,000 ₺ | 0% | 0% | 24h / trade | **Default:** All new users start here. |
| **Tier 1** | 5,001 – 50,000 ₺ | 8% | 10% | 24h / trade | ≥ 15 successful trades, **≤ 2 failed disputes** |
| **Tier 2** | 50,001 – 250,000 ₺ | 6% | 8% | Unlimited | ≥ 50 successful trades, **≤ 5 failed disputes** |
| **Tier 3** | 250,001 – 1,000,000 ₺ | 5% | 5% | Unlimited | ≥ 100 successful trades, **≤ 10 failed disputes** |
| **Tier 4** | 1,000,001+ ₺ | 2% | 2% | Unlimited | ≥ 200 successful trades, **≤ 15 failed disputes** |
...
| `pingMaker(tradeId)` | Allows the Taker to send a "liveness signal" to a passive Maker after the 48-hour `GRACE_PERIOD` has expired. This is a prerequisite for calling `autoRelease`. |
...
| `burnExpired(tradeId)` | Allows for all funds in a trade that has exceeded the 10-day bleeding period to be transferred to the Treasury. |
